...
int	change_user_data(int sockfd)
{
...
//退单与改签
int refund_and_change(int sockfd)
{
...
//普通用户登陆成功界面
int login_success(int sockfd, char *buf1)
{
	/*pthread_t t2;
...
//管理员界面
int admin_login_fun(int sockfd)
{
	system("clear");
	char buf[SIZEOF];
	while (1)
...
//选择登陆界面
int select_login_fun(int sockfd)
{
	char buf[SIZEOF];
	while (1)
	{
